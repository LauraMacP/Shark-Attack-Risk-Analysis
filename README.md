...
\#\# Dashboard Preview  
\!\[Shark Attack Dashboard\](visuals/dashboard\_screenshot.png)
...
\#\# How to View  
1\. Watch the project \[walkthrough video\](https://youtu.be/fX\_Eqg9OXxA)  
2\. Download the \[interactive dashboard\](powerbi/shark\_attack\_dashboard.pbix) and open in Power BI Desktop    
3\. View \[notebooks\](notebooks) directly on GitHub    
4\. Read the \[written responses PDF\](reports/written\_responses.pdf)
